 ...
 * @Nombre    : EstadisticaConsultas
 * @Author    : Erick Rodriguez
 * @Copyright : Erick Rodriguez
 * @Creado el : 06-sep-2021, 01:51:17 PM
 */
...
class EstadisticaConsultas extends TableGateway {

    private $dbAdapter;

    public function __construct(Adapter $adapter = null, $databaseSchema = null, ResultSet $selectResultPrototype = null) {
        $this->dbAdapter = $adapter;
        return parent::__construct('estadistica_consultas', $adapter, $databaseSchema, $selectResultPrototype);
    }
